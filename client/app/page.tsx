...
export default function Home() {
  const features = [
    ...
    },
    {
      ...
      title: "Top Companies",
      description:
        "Connect with leading companies, from innovative startups to Fortune 500 corporate companies.",
      benefits: [
        "500+ verifies employers",
      ...
      <section className="py-20 bg-gradient-to-b from-[#d7dedc] to-[#7263f3]/5 text-primary-foreground">
        <div className="container mx-auto px-4 text-center text-black">
          <h1 className="text-4xl text-[#7263f3] md:text-5xl font-bold mb-6">
            Find Your Dream Job or a Perfect Candidate
          </h1>
          <p className="text-xl mb-8">
            Connect with millions or employers and job seekers on our platform
          </p>
          <div className="max-w-2xl m-auto flex gap-4">
            <Input
              type="text"
      ...
      <section className="py-20 bg-[#f0f5fa]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose{" "}
            <span className="font-extrabold text-[#7263f3]">JobSphere</span>
          </h2>
